      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-login">
          <div class="panel-heading">
            <div class="row">
              <div class="col-xs-6">
                <a href="login_form" class="active" id="login-form-link">로그인</a>
              </div>
              <div class="col-xs-6">
                <a href="member_form" id="register-form-link">회원가입</a>
              </div>
            </div>
            <hr>
          </div>
          <div class="panel-body">
            <div class="row">
              <div class="col-lg-12">
                ...
                <form id="register-form" name="member_form" method="post" action="member_insert.php" role="form" style="display: none;">
                  <div class="form-group">
